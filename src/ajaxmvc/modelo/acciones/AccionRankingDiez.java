 ...
 * @version  Ajax-MVC2
 */
public class AccionRankingDiez implements Accion {
	/**
	...
	public boolean ejecutar(HttpServletRequest request,
		...
		if (procesaBD.getRankingDiez() != null){		
			
		
			
		}else{
			ranking.setError("Error al cargar el ranking");
		}
		json = new Gson().toJson(procesaBD.getRanking());
